...
> Not affiliated with [CirclesUBI](https://github.com/CirclesUBI). The name predates familiarity with that project.
...
- **[Circles-contract](https://github.com/Obinna-e/Circles-contract)** (this repo): the on-chain Solidity contract.
- **[Nft-Generator](https://github.com/Obinna-e/Nft-Generator)**: a Flutter app that generates the art (PNG) and ERC-721 metadata (JSON) locally, ready to be pinned to IPFS.
- **[NFT-Contract-Minter](https://github.com/Obinna-e/NFT-Contract-Minter)**: a Flutter app that calls the deployed contract to mint each token with its IPFS metadata URI.
